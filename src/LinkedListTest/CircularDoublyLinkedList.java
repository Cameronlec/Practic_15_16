...
public class CircularDoublyLinkedList<E> implements Iterable<E>, Cloneable {
    private Node head;
    private int size;
    ...
    CircularDoublyLinkedList(Collection<? extends E> list) {
        this();
        addAll(list);
    }
    ...
    @SafeVarargs
    public static <T> CircularDoublyLinkedList<T> of(T... values) {
        CircularDoublyLinkedList<T> list = new CircularDoublyLinkedList<>();
        if (values != null) {
            for (T value : values) {
                list.add(value);
            }
    ...
    @SuppressWarnings("unchecked")
    private CircularDoublyLinkedList<E> superClone() {
        try {
            return (CircularDoublyLinkedList<E>) super.clone();
    ...
    @SuppressWarnings("unchecked")
    @Override
    protected CircularDoublyLinkedList<E> clone() {
        CircularDoublyLinkedList<E> clone = superClone();
        clone.clear();
